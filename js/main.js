...
$(document).ready(function() {
        ...
        $map.slideToggle({
            complete: function() {
                ...
                if (!isMapLoaded) {
                    ...
                    map = new GMaps({
                        el: '#gmap-wrapper',
                        lat: 17.4458318, //Replace Here Location Google Map Lat
                        lng: 78.3492795, //Replace Here Location Google Map Lat
                        scrollwheel: false,
                        zoom: 17,
                        zoomControl: true,
                        panControl: true,
    ...
    $("#contactForm").submit(function(event) {
        ...
        var posting = $.post( url, { name: $('#name').val(), email: $('#email').val(), subject: $('#subject').val(), message: $('#message').val() } );
